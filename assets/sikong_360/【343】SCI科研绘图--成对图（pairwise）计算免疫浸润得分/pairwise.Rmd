...
- easy_input_expr1.csv，easy_input_expr2.csv，TCGA的表达数据
- easy_input_maf1.txt，easy_input_maf2.txt，TCGA的突变数据
- immunitygene.csv，免疫细胞marker基因，这里用GSVA。还可以用MCPcounter
