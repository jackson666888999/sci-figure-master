...
write.table(stat.test2,paste0('step7.',myindex,'.violine.pdf.stat.xls'),row.names = F,sep = '\t',quote = F)

ggsave(paste0('step7.',myindex,'.violine.pdf'),width = 4,height = 4)
