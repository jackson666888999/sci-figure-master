...
_PRESENTATION_CHARTS = {
    ...
    "mechanism_diagram": {"id": "mechanism_diagram", "name": "Mechanism Diagram", "name_zh": "机制示意图(BioRender风格)",
                          "category": "Presentation", "domains": ["academic", "mechanism", "pathway", "General"],
                          "engine": "Python(matplotlib)可编辑SVG", "description": "BioRender 风格机制图：entities+relations 结构化输入 → 圆角节点+激活/抑制箭头+证据分级标注，多格式可编辑输出"},
    "graphical_abstract": {"id": "graphical_abstract", "name": "Graphical Abstract", "name_zh": "图形摘要",
                           "category": "Presentation", "domains": ["academic", "paper"],
                           "engine": "Python(matplotlib)", "description": "论文图形摘要：机制图+数据面板混合布局（可调用 biorender-pro skill 增强）"},
    "pathway_diagram": {"id": "pathway_diagram", "name": "Pathway Diagram", "name_zh": "通路图",
                        "category": "Presentation", "domains": ["academic", "pathway", "KEGG"],
                        "engine": "Python(matplotlib)", "description": "信号通路/代谢通路图（KEGG 风格或自定义实体-关系）"},
    "flowchart": {"id": "flowchart", "name": "Flowchart", "name_zh": "流程图",
                  "category": "Presentation", "domains": ["academic", "report", "workflow"],
                  "engine": "Python(matplotlib)/Mermaid", "description": "研究流程/分析流程图（graphviz/mermaid/matplotlib）"},
